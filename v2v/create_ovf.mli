...
val create_ovf : string -> Types.source -> Types.target list -> Types.guestcaps -> Types.inspect -> Types.target_firmware -> Types.target_nics -> Types.output_allocation -> string -> string list -> string list -> string ->  ovf_flavour -> DOM.doc
(** Create the OVF file.

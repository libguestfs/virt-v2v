...
=item B<-ic vpx://...> B<-it pynfc>

=item B<-ic esx://...> B<-it pynfc>

Full documentation: L</INPUT FROM PYNFC>

Use the Python NFC port 902 implementation.  This is a free
alternative to VDDK.
...
This is similar to the VNX method above, except it uses an SSH
...
non-free software then the pynfc, VMX or SSH methods will be best.
...
=head1 INPUT FROM PYNFC

Use the Python NFC port 902 implementation, which is a free
